          		...
          		<div class="row-fluid">
          			<div class="span3">
	          			<div class="control-group">
	            			...
	            			<div class="controls">
	              				<select name="country" id="country" class="input-large">
	              					<option value=""></option>
	          		...
	          		<div class="span6">
	          			<div class="control-group">
	            			<label class="control-label">City:</label>
	            				<div class="controls">
	              					<input type="text" class="input-large" name="city" id="city" value="${client.city}">
	            				</div>
	          			</div>
	          		</div>
          		</div>
          		...
          		<div class="row-fluid">
          			<div class="span3">
	          			<div class="control-group">
			            	...
			            	<div class="controls">
			              		<input type="text" name="telephone" class="input-medium" id="telephone" value="${client.telephone}">
			            	</div>
			        	</div>
	          		</div>
	          		<div class="span4">
	          			...
	          			<div class="control-group">
				            ...
				            <div class="controls">
			              		<select name="acquisition" class="input-medium" id="acquistion">
			                		...
			                		<option value="Website" <c:if test="${client.acquisitionType == 'Website'}">selected</c:if>>Website</option>
			              		</select>
			            	</div>
			            </div>
	          		</div>
