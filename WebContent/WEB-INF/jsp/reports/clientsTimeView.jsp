...
<jsp:include page="../header.jsp" >
    ...
    <jsp:param name="sub" value="../" />
		...
		<div id="revenue_chart" style="height:500px;"></div>
		<div id="revenue_chart_script"></div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$("#generateReportBtn").click(function(){
					...
					$.get("${path}reports/revenue.do", { startDate: startDate, endDate : endDate, allTimes: allTimes },
					        function(data){
								$("#revenue_chart_script").append(data);
							}
					);
